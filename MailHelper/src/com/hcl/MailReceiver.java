...
public class MailReceiver {
	...
	public static void main(String[] args) {
		...
		String port = "995";
		String userName = "rsamrat073@gmail.com";
		String password = "9!0@9#0$*4#SA";
		boolean stopThread = false;
		String dummy = "success", saveDirectory = "D:/Attachment";

		MailReceiver mailReceiver = new MailReceiver();
		mailReceiver.setSaveDirectory(saveDirectory);

		mailReceiver.downloadEmailAttachments(host, port, userName, password);
	}
